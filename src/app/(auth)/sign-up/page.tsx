...
export default function SignUpForm() {
  ...
  return (
    <div className="p-5  md:p-10 flex justify-center items-center min-h-screen ">
      <div className="w-full max-w-md p-8 space-y-8 bg-white text-black rounded-lg shadow-md">
        ...
        <Form {...form}>
          <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
            ...
            />
            <Button type="submit" className='w-full bg-black text-white dark:bg-black dark:text-white' disabled={isSubmitting}>
              {isSubmitting ? (
                <>
